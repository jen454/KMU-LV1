...
#define _DUTY_NEU 1498  // Servo angle: 0 degree
#define _DUTY_MIN 796   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 225 // Replace with |D - E| degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 716 + (-2.47 * a_value) + (2.11E-03 * (a_value) * (a_value));
}
